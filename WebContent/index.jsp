<!DOCTYPE html>
  <html>
    ...
    <body>
      ...
      <div class="center">
        <div class="menu-bar">欢迎您+用户名</div>
      </div>
      <div class="center">
          ...
          <div class="i-container" style="margin-top: 0px;">
            <div class="i-body" id="ctl00_ContentPlaceHolder1_Div1" style="padding: 0px;">
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                  <tr>
                    <th style="text-indent: 12px;">åºå·</th>
                    <th>
                      <span id="ctl00_ContentPlaceHolder1_span3" onclick="order2(3)">åç§°</span>
                    </th>
                    <th>
                      <span id="ctl00_ContentPlaceHolder1_span6" onclick="order2(6)">åå»ºæå¸</span>
                    </th>
                    <th>
                      <span id="ctl00_ContentPlaceHolder1_span2" onclick="order2(2)">æ´æ°æ¥æ</span>
                    </th>
                    <th>
                      <span id="ctl00_ContentPlaceHolder1_span1" style="background:url(images/down.gif) right no-repeat ;" onclick="order2(1)">ç¹å»</span>
                    </th>
                  </tr>
                  <tr class="crossing">
                    ...
                    <td>
                      ...
                      <a title="html" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>html</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="åå°">
                      <div class="ClearstrText" style="height:25px;width:85px">åå°</div>
                    </td>
                    <td title="2016/4/18" 20:35:23="">2016/4/18 </td>
                    <td>
                      <a href="course_html.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="javascript" class="left" style="position:relative;top:30px;left:6px;" target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>javascript</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="èå">
                      <div class="ClearstrText" style="height:25px;width:85px">èå</div>
                    </td>
                    <td title="2019/10/26" 19:16:48="">2019/10/26</td>
                    <td>
                      <a href="course_javascript.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr class="crossing">
                    ...
                    <td>
                      ...
                      <a title="css" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>css</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="å¾å½äº®">
                      <div class="ClearstrText" style="height:25px;width:85px">å¾å½äº®</div>
                    </td>
                    <td title="2016/5/19" 12:47:36="">2016/5/19 </td>
                    <td>
                      <a href="course_css.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="jsp" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>jsp</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="å·©æ¶">
                      <div class="ClearstrText" style="height:25px;width:85px">å·©æ¶</div>
                    </td>
                    <td title="2020/11/13" 12:58:28="">2020/11/13</td>
                    <td>
                      <a href="course_jsp.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr class="crossing">
                    ...
                    <td>
                      ...
                      <a title="servlet" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>servlet</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="èç">
                      <div class="ClearstrText" style="height:25px;width:85px">èç</div>
                    </td>
                    <td title="2012/12/21" 9:50:46="">2012/12/21</td>
                    <td>
                      <a href="course_servlet.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="vue" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>vue</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="å­ä¸¹">
                      <div class="ClearstrText" style="height:25px;width:85px">å­ä¸¹</div>
                    </td>
                    <td title="2013/8/10" 20:41:16="">2013/8/10 </td>
                    <td>
                      <a href="course_vue.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr class="crossing">
                    ...
                    <td>
                      ...
                      <a title="Ajax" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>Ajax</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="éµå">
                      <div class="ClearstrText" style="height:25px;width:85px">éµå</div>
                    </td>
                    <td title="2012/4/6" 16:25:55="">2012/4/6 </td>
                    <td>
                      <a href="course_Ajax.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="jQuery" class="left" style="position:relative;top:30px;left:6px;"  target="_blank">
                        <div class="ClearstrText" style="height:25px;width:140px;font-size:large;"><b>jQuery</b></div>
                      </a>
                      <div class="clear">
                      </div>
                    </td>
                    <td title="åç§">
                      <div class="ClearstrText" style="height:25px;width:85px">åç§</div>
                    </td>
                    <td title="2019/5/30" 11:33:20="">2019/5/30 </td>
                    <td>
                      <a href="course_jQuery.jsp">å¼å§å­¦ä¹ </a>
                    </td>
                    <td>
                      <span class="tools left" style="position:relative;left:5px;top:1px" onmouseover="show2(this.nextSibling)" onmouseout="hidden2(this.nextSibling);">
                      </span>
