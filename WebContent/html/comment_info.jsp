...
<%@page import="Db.Dbutil" %><!DOCTYPE html>
<html>
                        ...
                        <li class="icon">
						  <div class="icon_relative j_user_card">
                            <a class="p_author_face j_frame_guide" style="width:80px;height:80px;padding:10px;background:url(//tb2.bdstatic.com/tb/static-common/img/props/80/1100104.png) no-repeat;border:none" href="/home/main?un=%E5%95%8A%E5%92%BF%E5%8F%A4%E4%B8%BD00&amp;ie=utf-8&amp;id=tb.1.88480ff5.YvFmQofpJAxIskCx6suU-A?t=1569129182&amp;fr=pb" target="_blank">
                              <img class="j_dynamic_photo" src="https://imgsa.baidu.com/forum/eWH=150,150;bp=1090101,0,0,200/sign=490db748c395d143c81c992e42c5b22e/37d12f2eb9389b504468bb198e35e5dde6116ee1.jpg" username="啊咿古丽00">
                            </a>
                          </div>
                        </li>
                      ...
                      <div class="p_content  "> 
                            ...
                            <div class="post_bubble_middle" style="background:url(//tb1.bdstatic.com/tb/cms/post/bubble/lufei_02.png)">
                              <div class="post_bubble_middle_inner"> 
                                <h1>标题</h1>
                                <br>
                                <br>11月9日 消息:据企查查数据显示，近日，小霸王文化发展有限公司被申请破产重整，申请人为殷小云。
                                <br>
                                <br>
                                <br>
                                <br>而此前，据中山市第一人民法院下发的限制消费令显示，小霸王法定代表人冯宝伦已被限制高消费。此外，小霸王还曾多次被列为被执行人，并涉及多起股权投资款的纠纷。
                                <br>
                                <br>对于小霸王来说，被申请破产重组也许是最好的办法，因为自2019年起，小霸王文化已牵涉多达98起司法案件，其中，涉及多起股权投资款的纠纷。
                                <br>
                                <br>2018年4月4日，小霸王曾宣布正式重新回归游戏机市场，大力开发更加重视玩家体验的游戏主机与游戏平台。
                                <br>
                                <br>随后，还有消息称，小霸王已成功将游戏主机平台及软件调试完毕，小霸王还针对老年群体推出了“小霸王Z+乐百岁抗衰游戏健脑机”。
                                <br>
                                <br>对此，小霸王方面回应称，主机项目仍处于暂停阶段。如有第三方假借名义对外宣传或签署各种合同、协议，将保留追究其法律责任的权利。
                                <br>
                                <br>责任编辑：詹哲
                                <br>
                                <br>
                        ...
                        <div class="user-hide-post-down" style="display: none;">
                         ...
                         <div class="core_reply_tail clearfix">
                          <a class="p_reply p_reply_first" href="#" rel="noopener">回复</a>
                          <a class="p_reply p_reply_first" href="#" rel="noopener">点赞</a>
